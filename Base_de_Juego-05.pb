; -----------------------------------------------------------------------
; Base_de_Juegos-05 en PureBasic
...
; ---------------------------------------------------
;
; Programa 05 (Rotación de Sprite Soldado)
;
...
; municiones.
;
; Como verá el control del movimiento es muy rapido. En el proximo programa
; (el numero 6 de la series de este curso), el efecto del disparo se completa
; con un FOGONAZO en la punta del la pistola.
;
...
OpenWindow(#Ventana_Principal, 0, 0, MaxAncho, MaxAlto + 50, "Base de Juego-05 (Rotación Sprite Soldado)", #FLAGS) ;ventana principal
