; -----------------------------------------------------------------------
; Base_de_Juegos-03 en PureBasic
...
; ---------------------------------------------------
;
; Programa 03 (Sprite animado a través de 18 imágees BMP)
;
; Este programa es una versión más robusta del 01 y del 02
; Incluye una estructura completa para el soporte de un Sprite animado de un perrito
; cuyo movimiento se controla con las teclas de flecha de cursor.
;
; La pantalla se ha mejorado, y el label que indica que tecla se ha presionado se 
; ha incluido en una zona de pantalla que no es usada por nuestro sprite
;
; Si el usuario presiona las teclas de movimiento del CURSOR el sprite se mueve por
; la pantalla mostrando una animación controlada por una secuencia de movimiento.
;
; El programa es capaz de detectar si el movimiento cambia a derecha o izquierda
; para usar diferentes secuencias de graficos
;
...
OpenWindow(#Ventana_Principal, 0, 0, MaxAncho, MaxAlto + 50, "Base de Juego-03 (Perrito)", #FLAGS) ;ventana principal
